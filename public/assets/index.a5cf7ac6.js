...
const axios$2 = createInstance(defaults$2);
...
api.interceptors.response.use(
  ...
  (err) => {
    ...
    if ([400].includes(err.response.status)) {
      ...
      const items = errors.map((err2) => ({
        field: err2.path,
        message: err2.msg
      }));
      store2.setErrors(items);
    }
...
const _sfc_main = {
  ...
  setup(__props) {
    const store2 = postStore();
    const $q = useQuasar();
    const errors = computed(() => store2.getErrors);
    const message = computed(() => store2.getMessage);
...
const routes = [
  {
    path: "/",
    component: () => __vitePreload(() => import("./MainLayout.bf13c3f3.js"), true ? ["assets/MainLayout.bf13c3f3.js","assets/use-dark.54d6c3e0.js","assets/use-timeout.e460b770.js","assets/format.801e7424.js","assets/plugin-vue_export-helper.21dcd24c.js"] : void 0),
    children: [
      { path: "", component: () => __vitePreload(() => import("./HomePage.b2dfc885.js"), true ? ["assets/HomePage.b2dfc885.js","assets/QInput.67785307.js","assets/use-dark.54d6c3e0.js","assets/QCard.04ee0b73.js","assets/format.801e7424.js","assets/AppCard.72541c59.js","assets/AppCard.25364ead.css","assets/plugin-vue_export-helper.21dcd24c.js"] : void 0) },
      { path: "/post/create", component: () => __vitePreload(() => import("./CreateUpdatePage.cdefec11.js"), true ? ["assets/CreateUpdatePage.cdefec11.js","assets/CreateUpdatePage.6df132a6.css","assets/QInput.67785307.js","assets/use-dark.54d6c3e0.js","assets/QCard.04ee0b73.js","assets/plugin-vue_export-helper.21dcd24c.js"] : void 0) },
      { path: "/post/:idCard", component: () => __vitePreload(() => import("./CardPage.877d6484.js"), true ? ["assets/CardPage.877d6484.js","assets/AppCard.72541c59.js","assets/AppCard.25364ead.css","assets/QCard.04ee0b73.js","assets/use-dark.54d6c3e0.js","assets/plugin-vue_export-helper.21dcd24c.js","assets/use-timeout.e460b770.js"] : void 0) },
      { path: "/post/:idCard/update", component: () => __vitePreload(() => import("./CreateUpdatePage.cdefec11.js"), true ? ["assets/CreateUpdatePage.cdefec11.js","assets/CreateUpdatePage.6df132a6.css","assets/QInput.67785307.js","assets/use-dark.54d6c3e0.js","assets/QCard.04ee0b73.js","assets/plugin-vue_export-helper.21dcd24c.js"] : void 0) }
    ]
  },
  {
    path: "/:catchAll(.*)*",
    component: () => __vitePreload(() => import("./ErrorNotFound.beebbd1d.js"), true ? ["assets/ErrorNotFound.beebbd1d.js","assets/plugin-vue_export-helper.21dcd24c.js"] : void 0)
  }
];
...
createQuasarApp(createApp, quasarUserOptions).then((app2) => {
  ...
  return Promise[method]([
    __vitePreload(() => import("./i18n.f99b6926.js"), true ? [] : void 0),
...
export { QBtn as $, addEvt as A, preventDraggable as B, prevent as C, stop as D, position as E, Fragment as F, cleanEvt as G, stopAndPrevent as H, withDirectives as I, hDir as J, provide as K, pageContainerKey as L, reactive as M, hMergeSlot as N, useRouterLinkProps as O, Platform as P, useRouterLink as Q, isKeyCode as R, openBlock as S, Text as T, createBlock as U, withCtx as V, QIcon as W, createCommentVNode as X, createTextVNode as Y, toDisplayString as Z, resolveComponent as _, onUnmounted as a, createBaseVNode as a0, createElementBlock as a1, renderList as a2, mergeProps as a3, History as a4, vmHasRouter as a5, css as a6, getElement as a7, getEventPath as a8, onDeactivated as a9, vmIsDestroyed as aa, btnDesignOptions as ab, btnPadding as ac, getBtnDesign as ad, postStore as ae, useRoute as af, useRouter as ag, useAlignProps as ah, useAlign as ai, Transition as aj, QSpinner as ak, renderSlot as al, formKey as am, debounce as an, injectProp as ao, onBeforeUpdate as ap, onActivated as aq, shouldIgnoreKey as ar, useQuasar as as, withModifiers as at, getParentProxy as au, Teleport as av, createGlobalNode as aw, removeGlobalNode as ax, childHasFocus as ay, isRef as b, computed as c, defineComponent as d, effectScope as e, createVNode as f, getCurrentInstance as g, h, inject as i, boot as j, createComponent as k, hSlot as l, isRuntimeSsrPreHydration as m, onBeforeUnmount as n, onMounted as o, noop$3 as p, nextTick as q, ref as r, listenOpts as s, emptyRenderFn as t, layoutKey as u, hUniqueSlot as v, watch as w, createDirective as x, client as y, leftClick as z };
